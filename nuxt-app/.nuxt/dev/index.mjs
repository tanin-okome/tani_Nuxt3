...
const _lazy_NqZM36 = () => Promise.resolve().then(function () { return userUpdate$1; });
...
const handlers = [
  ...
  { route: '/api/user-update', handler: _lazy_NqZM36, lazy: true, middleware: false, method: undefined },
...
const userUpdate = defineEventHandler(async (event) => {
...
const userUpdate$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: userUpdate
});
