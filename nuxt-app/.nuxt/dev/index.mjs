...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/devalue/index.js';
import destr from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/vue/index.mjs';
import BaseStyle from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/@primeuix/styled/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\tanio\\Desktop\\Nuxt\\tani_Nuxt3\\nuxt-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\tanio\\Desktop\\Nuxt\\tani_Nuxt3\\nuxt-app\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\tanio\\Desktop\\Nuxt\\tani_Nuxt3\\nuxt-app\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\tanio\\Desktop\\Nuxt\\tani_Nuxt3\\nuxt-app\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\tanio\\Desktop\\Nuxt\\tani_Nuxt3\\nuxt-app\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9Dctn1Y5U9 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app";
...
const runtimeConfig = useRuntimeConfig();
const config$1 = runtimeConfig?.public?.primevue ?? {};
...
const _3F7P5LrF3m = defineNitroPlugin(async (nitroApp) => {
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_wXCARG, lazy: true, middleware: false, method: undefined }
];
...
const test = defineEventHandler(async (event) => {
  const result = await db.select().from(users$2);
  return result;
});
...
const userApi = defineEventHandler(async (event) => {
...
const userInsert = defineEventHandler(async (event) => {
  ...
  const insertresult = await db.insert(users$2).values({ name: body.name, email: body.email });
  return insertresult;
});

const userInsert$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: userInsert
});
...
const getClientManifest = () => import('file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/tanio/Desktop/Nuxt/tani_Nuxt3/nuxt-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
